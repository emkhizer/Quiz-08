...
const quiz = await inquirer.prompt([
    ...
    },
    {
        name: "question_2",
        type: "list",
        message: "Which of the following is the correct way to define a variable in TypeScript with a specific type?",
        choices: [
            "let name = 'John';",
    ...
    },
    {
        name: "question_4",
        type: "list",
        message: "Which of the following TypeScript features allows you to check the types at compile time?",
        choices: [
            "Type Inference",
            "Type Annotations",
            "Type Aliases",
